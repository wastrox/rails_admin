# require 'jsonapi_client'
require 'rails_admin/adapters/jsonapi_client/abstract_object'
require 'rails_admin/adapters/jsonapi_client/association'
require 'rails_admin/adapters/jsonapi_client/property'
  ...
  module Adapters
    module JsonapiClient
      ...
      def all(options = {}, scope = nil)
        ...
        sort_col = options[:sort] ? options[:sort].split('.').last : ''
        scope = scope.order( sort_col => options[:sort_reverse] ? :asc : :desc) if options[:sort]
        scope
      end

      def count(options = {}, scope = nil)
        all(options.merge(limit: false, page: false), scope).all.count
      end
